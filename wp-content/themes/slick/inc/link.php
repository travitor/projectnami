<?php $meta = get_post_meta( get_the_ID(), 'mav_link', true ); ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<hgroup>
			<h2 class="entry-title"><a href="<?php echo $meta; ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'mav' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
			<?php /* <h3 class="entry-format"><?php _e( 'Link', 'mav' ); ?></h3> */ ?>
			<span class="link">&ndash; <?php echo $meta; ?></span>
		</hgroup>
