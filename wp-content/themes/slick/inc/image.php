<article id="post-<?php the_ID(); ?>" <?php post_class( 'indexed' ); ?>>
	...
	<header class="entry-header">
		...
		<hgroup>
			...
			<?php /* <h3 class="entry-format"><?php _e( 'Image', 'mav' ); ?></h3> */ ?>
		</hgroup>
	...
	<footer class="entry-meta">
		...
		<div class="entry-meta">
			<?php
				printf( __( '<a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" pubdate>%3$s</time></a><span class="by-author"> by <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>', 'mav' ),
