...
function optionsframework_add_admin() {
	...
	$of_page = add_theme_page('themes.php', 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');

	//	Load Slider Manager
	add_theme_page('themes.php', 'Slider Manager', 'edit_theme_options', 'slidermanager', 'manager_wrap');
//	add_submenu_page('themes.php', $themename, "Slider Manager", 'edit_theme_options', 'slidermanager','manager_wrap');
...
<div class="wrap" id="of_container">
	...
	<form action="" enctype="multipart/form-data" id="ofform">
    	<div id="header">
			...
			<div class="version"><?php echo $themeversion; ?></div>
