...
class Ai1ec_App_Controller {
	...
	public function load_frontend_js( $is_calendar_page ) {
		...
		if( $this->check_if_single_event_page() === TRUE ) {
			...
			$this->localize_script_for_requirejs( 'ai1ec_event_category', 'ai1ec_config', $data );
		}
	...
	*/
	...
	private function check_if_single_event_page() {
		return isset( $_GET['ai1ec_event'] ) && $_GET['ai1ec_event'] !== '';
	}
	/**
	 ...
	 */
	function localize_script_for_requirejs( $handle, $object_name, $l10n ) {
		global $wp_scripts;
