...
function ( $, domReady, ai1ec_config, gmaps_helper, input_coordinates_event_handlers, date_time_event_handlers, facebook_export, calendrical_functions ) {
	...
	var attach_event_handlers = function() {
		...
		$( '#publish' ).click( input_coordinates_event_handlers.validate_coordinates_when_publishing );
		...
		$( '#ai1ec_bottom_publish' ).on( 'click', '#ai1ec_end', date_time_event_handlers.trigger_publish );
